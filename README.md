...
En el trabajo práctico de señales se desarrolló un sistema automatizado en Python para el preprocesamiento, segmentación y extracción de características de señales biomédicas. 
...
Se buscó la validar ciertos biomarcadores específicos, como el aumento de la potencia relativa Theta y la reducción del ratio Alpha/Theta, como indicadores consistentes de Parkinson temprano.
